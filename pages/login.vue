	...
	<UContainer class="flex items-center justify-center h-screen bg-background">
		<div class="w-full max-w-md p-6 space-y-6 bg-card rounded-lg shadow-lg">
			...
			<UForm :schema="schema" :state="state" class="space-y-4" @submit="handleSubmit($event, state)">
				...
				<button type="submit" class="w-full text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-gray-800 shadow-lg shadow-gray-500/50 dark:shadow-lg dark:shadow-gray-700/80 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 animate__animated transition ease-in-out duration-300">
					Войти
				</button>
			</UForm>
